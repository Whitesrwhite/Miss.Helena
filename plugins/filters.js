...
await message.client.sendMessage(message.jid, fs.readFileSync('uploads/mention.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.SAID, quoted : message.data, ptt: true})
        ...
        if (!!message.mention && message.mention[0] == '17098008221@s.whatsapp.net') {
...
const array = ['ayye','Ooh','ooh','Kk','thug','Thug','trance','Trance','Broken','broken','aara','Aara','Food','food','fud','Fud','Nee','nee','happy','Happy','Dud','Photo','photo','fan','Fan','Gd nyt','gd nyt','koi','Koi','vatt','Vatt','ara','Ara','name','Name','pinnalla','Pinnalla','Hai','Reply','reply','thall','Thall','Song','kozhi','Kozhi','I love you','line','list','Line','mass','Mass','arulle','Arulle','Feel','lub','Lub','Music','music','CR7','Halo','Aysheri','aysheri','kooi','Kooi','ith','🔥','bye','para','Para','mukesh','Mukesh','Hlo','hlo','njan','Njan','muthe','Muthe','Xxxtentacion','alone','Alone','potta','Potta','menu','welcome','Welcome','vannu','Vannu','Remove','kyat','rip','remix','Remix','Rip','Myr','dj','Dj','pever','Pever','Oo','XXXTENTACION','Love u','hate','Hate','Njan vannu','tto','Audio','audio','veno','xxxtentacion','Veno','nanban','Ayye','Ronaldo','ronaldo','Kundan','katha','hy','vaanam','Vaanam','Vanam','Ivan','ivan','Annan','annan','Thayoli','umbi','Umbi','Noob','Single','noob','single','Nanban','Ok','Shiva','ok','Enth','enth','nth','Edi','kundi','Kundi','Uff','Dey','Cr7','Poda','Poli','Pm','Plzz','girl','Oi','nirth','Nirth','good nyt','birthday','HBD','bdy','Birthday','Pattula','Good night','Nth','Mood','Please','Mm','Dance','Ith','thech','caption','Polikk','Aah','Good nyt','Mrng','alive','Di','Bro','avan','Allah','bg','Hii','odiko','oho','killadi','oo','Fuck','invite','Hi','love','Bgm','Owner','Group','man','Nanba','oii','poda','yo','sad','work','set','remove','thukum','poko','myre,','kundan','xmedia','commands','Boss','vava','Myre','Lalitha','start','sing','Hello','Bye','warn','Baby','who','find','power','myr','vanam','tagall','Re entry','pass','patti','phaa','mone','look','bor','try','owner','luv','feel','romam','potte','no replay','bgm','vijay','poli','Da','Vazha','help','kunna','Kunna','Sorry','Sry','sorry','sry','Bot','bot','song','Uyir','uyir','myre','thayoli','Love','Hy','sed','Sed','Sad','Ayn']
array.map( async (a) => {
...
await message.client.sendMessage(message.jid, fs.readFileSync('Amalserv2/.mp3'), MessageType.audio, { mimetype: Mimetype.mpAudio,duration: Config.SAID, contextInfo: { forwardingScore: 5, isForwarded: true }, quoted : message.data, ptt: true})
        ...
        var uri = encodeURI(match[1])
const array = ['Hi','pro','coming','alive','list','go','menu','koii','update','wait','Mrng','like','bad','nice','link','Hii','ok','myr','set','ayo','i want','help','working','life','Da','fix','promiss','sed','old','fek','Kozhi','ee','single','one side','muthe','Aliya','audio','oh','something','Myre','caption','di','love','you','update now','super','iwa','erorr','status','Dii','feel','kuppy','bst','maduthu','niyo','what','but y','chakare','mone','uyir','friends','owner','shit','fan','fans','Broken','E bullet','Hello','over','ayikotte','kollam','muthe','propose','rain','kozhi']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
...
const array = ['Error','error','Mm','umma','Umma','Oi','Ezra','ezra','Hi','Ok','ok','Sorry','sorry','nna','Nna','name','Name','myre','Myre','inna','Inna','Malare','git','chaya','escape','truth','hm','pottan','oh','nokk','nude','oo','hi','kali','Remove','bot','lost','copy','Da','come','sex','help','sorry','podi','nee','done','kalam','Di','Dey','oho','Welcome','Nanba','ee','Hello','para','kindi','list','check','podey','odiko','save','Hii','oii','sad','sed','thenga','bad','run','remove','love','kick','enth','alive','menu','ella','unmute','mute','Ayye','pm','Hhee','Patti','Chumma paranjatha','Myr','rply','selfie','ban','Sad','fuk','Engenend','Pattula','da','kittiyo','Comedy','resendo','Poda','mrng','Bot',]
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
