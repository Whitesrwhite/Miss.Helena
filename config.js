...
module.exports = {
    ...
    SESSION: process.env.WHITE_SER_CODE === undefined ? '' : process.env.WHITE_SER_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/kF5SpFM.jpeg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'default' : process.env.KICKME_MESSAGE,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    WELCOME: process.env.WELCOME === undefined ? 'pp' : process.env.WELCOME,
    OWNER: process.env.OWNER_NAME === undefined ? '💖WHITE💖' : process.env.OWNER_NAME,
    PHONE: process.env.NUMBER === undefined ? '+919605741366' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'WHITE' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By 𝚆𝙷𝙸𝚃𝙴 𝚂𝙴𝚁' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '436703081866810@s.whatsapp.net' : process.env.TAG_REPLY,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    PLKS: process.env.THERI_LIST === undefined ? false : process.env.THERI_LIST,
    AFPLK: process.env.YT_PASSWORD === undefined ? 'afamk' : process.env.YT_PASSWORD,
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/kF5SpFM.jpeg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? '𝚆𝙷𝙸𝚃𝙴 𝚂𝙴𝚁' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ 𝚆𝙷𝙸𝚃𝙴 𝚂𝙴𝚁 ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? '𝚆𝙷𝙸𝚃𝙴 𝚂𝙴𝚁' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/kF5SpFM.jpeg' : process.env.ALL_IMG,
    ...
    WEL_GIF: process.env.WEL_GIF === undefined ? 'https://i.imgur.com/kF5SpFM.mp4' : process.env.WEL_GIF,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://i.imgur.com/kF5SpFM.mp4' : process.env.GIF_BYE,
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'White🎗️/💝/✨/📝' : process.env.CMD_LIST,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Note this' : process.env.TAG_HEADER,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    YAK: process.env.YAK === undefined ? '17098008221,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
